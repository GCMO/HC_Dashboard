      ...
      <CardContent>
        <Timeline>
          ...
          <TimelineItem>
            ...
            <TimelineContent>
              <Box sx={{ mb: 2, display: 'flex', lexWrap: 'wrap',
          ...
          <TimelineItem>
            ...
            <TimelineContent>
              <Box
                sx={{ mb: 2, display: 'flex', lexWrap: 'wrap', alignItems: 'center', justifyContent: 'space-between'
                }}
              >
                <Typography variant='body2' sx={{ mr: 2, fontWeight: 600, color: 'text.primary' }}>
...
export default UsersTimelineListTable;